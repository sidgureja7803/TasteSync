...
import { TranscriptionCreateParams, TranscriptionCreateResponse, Transcriptions } from "./transcriptions.js";
import * as TranslationsAPI from "./translations.js";
import { TranslationCreateParams, TranslationCreateResponse, Translations } from "./translations.js";
...
export declare class Audio extends APIResource {
    ...
    create(body: AudioCreateParamsStreaming, options?: Core.RequestOptions): APIPromise<Stream<AudioSpeechStreamChunk>>;
    create(body: AudioCreateParamsBase, options?: Core.RequestOptions): APIPromise<Stream<AudioSpeechStreamChunk> | Response>;
}
