...
export declare class Completions extends APIResource {
    ...
    create(body: CompletionCreateParamsStreaming, options?: Core.RequestOptions): APIPromise<Stream<CompletionChunk>>;
    create(body: CompletionCreateParamsBase, options?: Core.RequestOptions): APIPromise<Stream<CompletionChunk> | Completion>;
}
