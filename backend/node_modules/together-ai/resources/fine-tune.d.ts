...
export declare class FineTuneResource extends APIResource {
     ...
     * ```
     */
    retrieveCheckpoints(id: string, options?: Core.RequestOptions): Core.APIPromise<FineTuneRetrieveCheckpointsResponse>;
}
...
export declare namespace FineTuneListResponse {
    /**
     * A truncated version of the fine-tune response, used for POST /fine-tunes, GET
     * /fine-tunes and POST /fine-tunes/{id}/cancel endpoints
     */
...
export declare namespace FineTuneRetrieveCheckpointsResponse {
    interface Data {
